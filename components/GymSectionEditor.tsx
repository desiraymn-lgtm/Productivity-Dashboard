...
import { updateGymSection } from '@/app/actions';
import { RichText } from '@/lib/richtext';
import type { GymSection } from '@/lib/types';

export default function GymSectionEditor({ section }: { section: GymSection }) {
  const [isEditing, setIsEditing] = useState(false);
  const saveWithKey = updateGymSection.bind(null, section.section_key);
